    ...
    <ul aria-expanded="false" class="collapse">
        ...
        <?php while($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td>
                    <a href="edit_delivery_personnel.php?id=<?php echo $row['id']; ?>">Edit</a>
                    <a href="delete_delivery_personnel.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
