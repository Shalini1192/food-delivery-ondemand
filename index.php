...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> ON DEMAND FOOD DELIVERY </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/FOOD-DEVLIVERY.jpg">
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo">ON DEMAND DELIVERY </a>
																</div>
